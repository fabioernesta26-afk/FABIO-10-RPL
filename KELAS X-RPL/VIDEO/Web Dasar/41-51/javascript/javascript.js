function tampil() {
// dokument.qwerySelector('h1').innerHTML = "belajar javascript";
// document.qwerySelector('.container').style.backgroundColor = "red";
// document.qwerySelector("#para").style.fontSize = "50px"
